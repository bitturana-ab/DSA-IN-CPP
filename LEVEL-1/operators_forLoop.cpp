...
int main()
{
    ...
    // uc-comments which part you want to execute
    /*
    ...
    for (int i = 0; i < 5; i++)
    {
        cout << "Hii" << endl;
        cout << "Suno na" << endl;
        continue; // goesto next iteration and skip this next work
        cout << "Reply kr de.." << endl;
    }
    */

    // ahead problem solved in leetcode (bitturana_ab)
}
